...
def parse_args():
    """return all args
    """
    path = '/home/paddle/Desktop/Baidu_AI/yolov3/'
    ...
    add_arg('pretrain',         str,    path+'weights/darknet53', "The pretrain model path.")
    add_arg('weights',          str,    path+'weights/yolov3', "The weights path.")
    add_arg('dataset',          str,    'coco2017',  "Dataset: coco2014, coco2017.")
    add_arg('class_num',        int,    80,          "Class number.")
    add_arg('data_dir',         str,    path+'dataset/coco',        "The data root path.")
    add_arg('video_path',         str,    path+'../fresh.mp4',        "The source video path.")
    add_arg('video_dir',         str,    path+'../full.mp4',        "The output video path.")
